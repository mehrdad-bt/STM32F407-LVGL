...
void SystemClock_Config(void)
{
  ...
  */
  ...
  /*
   * RTC clock source for the current test:
   * LSI
   */
...
static void MX_RTC_Init(void)
{
  ...
  */
  ...
  /*
   * LSI is not exactly 32768 Hz.
   *
   * These prescalers were originally selected
   * for the first RTC test.
   */
...
static void MX_USART1_UART_Init(void)
{
  ...
  /* USER CODE BEGIN USART1_UART_Init 2 */

  /* USER CODE END USART1_UART_Init 2 */
}
